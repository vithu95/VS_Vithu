...
public class ManufacturerServer2 implements MqttCallback, Runnable {

    File allsensors = new File("ManufacturerServer2//Logging//logger.txt");
    ...
    public void run() {
        ...
        try {
            new ManufacturerServer2().subscribe("Server");
        } catch (InterruptedException ex) {
            Logger.getLogger(ManufacturerServer2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    public ManufacturerServer2() {
        try {
